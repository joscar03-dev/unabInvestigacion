...
namespace AKDEMIC.CORE.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        {
            var destinationTimeZone = new TimeSpan(GeneralConstants.TimeZoneInfo.Gmt, 00, 00).ToCustomTimeZone();
        ...
        {
            return dateTime.ToString(GeneralConstants.FORMATS.DATE, CultureInfo.InvariantCulture);
        }
        ...
        {
            return dateTime.ToString(GeneralConstants.FORMATS.DATETIME, CultureInfo.InvariantCulture);
        }
        ...
        {
            return dateTime.ToString(GeneralConstants.FORMATS.TIME, CultureInfo.InvariantCulture);
        }
        ...
        {
            return dateTime.ToDefaultTimeZone().ToString(GeneralConstants.FORMATS.DATE, CultureInfo.InvariantCulture);
        }
        ...
        {
            return dateTime.ToDefaultTimeZone().ToString(GeneralConstants.FORMATS.DATETIME, CultureInfo.InvariantCulture);
        }
        ...
        {
            return dateTime.ToDefaultTimeZone().ToString(GeneralConstants.FORMATS.TIME, CultureInfo.InvariantCulture);
        }
        ...
        public static DateTime ToUtcDateTime(this DateTime dateTime)
        {
            ...
            var result = TimeZoneInfo.ConvertTimeToUtc(dateTime, ConvertHelpers.FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
            return result;
        }
    }
}
