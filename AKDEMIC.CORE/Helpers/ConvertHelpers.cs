...
namespace AKDEMIC.CORE.Helpers
{
    public class ConvertHelpers
    {
        ...
        {
            return DateTime.ParseExact(date, GeneralConstants.FORMATS.DATE, System.Globalization.CultureInfo.InvariantCulture);
        }

        public static DateTime DatepickerToUtcDateTime(string date)
        {
            var dt = DateTime.ParseExact(date, GeneralConstants.FORMATS.DATE, System.Globalization.CultureInfo.InvariantCulture);//.ToUniversalTime();
            dt = DateTime.SpecifyKind(dt, DateTimeKind.Unspecified);
            return TimeZoneInfo.ConvertTimeToUtc(dt, FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
        }

        public static DateTime DatepickerCustomToUtcDateTime(string date)
        {
            var dt = DateTime.ParseExact(date, GeneralConstants.FORMATS.DATETIME_CUSTOM, System.Globalization.CultureInfo.InvariantCulture).ToUniversalTime();
            dt = DateTime.SpecifyKind(dt, DateTimeKind.Unspecified);
            return TimeZoneInfo.ConvertTimeToUtc(dt, FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
        }
        ...
        {
            return DateTime.ParseExact(datetime, GeneralConstants.FORMATS.DATETIME, System.Globalization.CultureInfo.InvariantCulture);
        }

        public static DateTime DatetimepickerToUtcDateTime(string datetime)
        {
            var dt = DateTime.ParseExact(datetime, GeneralConstants.FORMATS.DATETIME, System.Globalization.CultureInfo.InvariantCulture);
            dt = DateTime.SpecifyKind(dt, DateTimeKind.Unspecified);
            return TimeZoneInfo.ConvertTimeToUtc(dt, ConvertHelpers.FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
        }
        public static DateTime DatetimepickerCustomToUtcDateTime(string datetime)
        {
            var dt = DateTime.ParseExact(datetime, GeneralConstants.FORMATS.DATETIME_CUSTOM, System.Globalization.CultureInfo.InvariantCulture);
            dt = DateTime.SpecifyKind(dt, DateTimeKind.Unspecified);
            return TimeZoneInfo.ConvertTimeToUtc(dt, ConvertHelpers.FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
        }
        #endregion
        ...
        {
            var dt = DateTime.ParseExact(time, GeneralConstants.FORMATS.TIME, System.Globalization.CultureInfo.InvariantCulture);
            dt = DateTime.SpecifyKind(dt, DateTimeKind.Unspecified);
            return TimeZoneInfo.ConvertTime(dt, FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID), ConvertHelpers.FindOperatingSystemTimeZoneById(GeneralConstants.LINUX_TIMEZONE_ID, GeneralConstants.OSX_TIMEZONE_ID, GeneralConstants.WINDOWS_TIMEZONE_ID));
        }
