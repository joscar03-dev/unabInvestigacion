...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.Admin.Pages.InvestigacionIncubadoranew.InvestigacionIncubadoranewConvocatoriaproyectoadminPage
{
            ...
            if (tipousuario == "R")
            {
                ...
                var queryproyectodetalle2 =  _context.InvestigacionfomentoConvocatoriaproyectosflujos
                   ...
                   .Select(x => new
                   {
                       ...
                       retornadocente = x.queryproyectodetalle_1.retornadocente,
                       orden1= x.queryproyectodetalle_1.orden,
                       orden2 = x.queryproyectodetalle2_1.orden,
                       estado2= x.queryproyectodetalle2_1.estado,
                   })
                   .Where(x=>  (x.orden1 == 1 ? x.orden2 == 1 :  x.orden2 == x.orden1 - 1  && x.estado2=="1") )                   
                   .AsNoTracking();
                ...
                .Select(x => new
                {
                    ...
                    retornadocente = x.queryproyectodetalle2_1.retornadocente,
                ...
                .Where(x => (tipousuario == "R" ? x.estado == "1" : "1" == "1") && x.retornadocenteproyecto == "0" && x.IdOficina == xIdOficina)
