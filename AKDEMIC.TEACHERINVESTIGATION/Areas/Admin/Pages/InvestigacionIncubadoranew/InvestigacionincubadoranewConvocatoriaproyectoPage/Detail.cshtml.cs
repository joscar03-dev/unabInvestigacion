...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.Admin.Pages.InvestigacionIncubadoranew.InvestigacionIncubadoranewConvocatoriaproyectoPage
{
    ...
    public class DetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostEditProyectoAsync(InvestigacionfomentoConvocatoriaproyectoEditViewModel viewModel)
        {
            ...
            if (viewModel.tipo == "1")
            {
                investigacionfomentoconvocatoriaproyecto.descripcionemprendimiento = viewModel.descripcionemprendimiento;
            ...
            if (viewModel.tipo == "4")
            {
                investigacionfomentoconvocatoriaproyecto.ventajascompetitivascomparativas = viewModel.ventajascompetitivascomparativas;

            }
            if (viewModel.tipo == "5")
            {
                investigacionfomentoconvocatoriaproyecto.estudiomercado = viewModel.estudiomercado;

            }
            if (viewModel.tipo == "6")
            {
                investigacionfomentoconvocatoriaproyecto.estrategiamarketing = viewModel.estrategiamarketing;

            }
            if (viewModel.tipo == "7")
            {
                investigacionfomentoconvocatoriaproyecto.potencialessociosestrategicos = viewModel.potencialessociosestrategicos;
