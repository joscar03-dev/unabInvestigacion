...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.Admin.Pages.InvestigacionIncubadoranew.InvestigacionIncubadoranewConvocatoriaPage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public InvestigacionfomentoConvocatoriaCreateViewModel fechainiinscripcion { get; set; }

        public InvestigacionfomentoConvocatoriaCreateViewModel fechafininscripcion { get; set; } 

        [BindProperty(SupportsGet = true)]
        public InvestigacionfomentoConvocatoriaCreateViewModel Input { get; set; }
        [BindProperty(SupportsGet = true)]
        public InvestigacionfomentoConvocatoriaEditViewModel Input2 { get; set; }
        ...
        public async Task<IActionResult> OnPostCreateAsync(InvestigacionfomentoConvocatoriaCreateViewModel viewModel)
        {
            ...
            var investigacionfomentoconvocatoria = new InvestigacionfomentoConvocatoria
            {
                ...
                dirigidoa= viewModel.dirigidoa,
                fechainiinscripcion = ConvertHelpers.DatetimepickerToUtcDateTime(viewModel.fechainiinscripcion),
                fechafininscripcion = ConvertHelpers.DatetimepickerToUtcDateTime(viewModel.fechafininscripcion),
                IdFacultad = viewModel.IdFacultad,
                nroplaza = viewModel.nroplaza,
                presupuesto = viewModel.presupuesto,
                imagenarchivo = await storage.UploadFile(Input.PictureFile.OpenReadStream(), FileStorageConstants.CONTAINER_NAMES.INCUBATORCONVOCATION_PHOTOS,
        ...
        public async Task<IActionResult> OnPostEditAsync(InvestigacionfomentoConvocatoriaEditViewModel viewModel)
        {
            ...
            investigacionfomentoconvocatoria.dirigidoa = viewModel.dirigidoa;
            investigacionfomentoconvocatoria.fechainiinscripcion = ConvertHelpers.DatetimepickerToUtcDateTime(viewModel.fechainiinscripcion);
            investigacionfomentoconvocatoria.fechafininscripcion = ConvertHelpers.DatetimepickerToUtcDateTime(viewModel.fechafininscripcion);
            investigacionfomentoconvocatoria.IdFacultad = viewModel.IdFacultad;
            investigacionfomentoconvocatoria.nroplaza = viewModel.nroplaza;
            investigacionfomentoconvocatoria.presupuesto = viewModel.presupuesto;
            if (Input.PictureFile != null)
            {
                investigacionfomentoconvocatoria.imagenarchivo = await storage.UploadFile(Input.PictureFile.OpenReadStream(), FileStorageConstants.CONTAINER_NAMES.INCUBATORCONVOCATION_PHOTOS,
                            Path.GetExtension(Input.PictureFile.FileName), FileStorageConstants.SystemFolder.TEACHER_INVESTIGATION);
        ...
        public async Task<IActionResult> OnGetDetailAsync(Guid id)
        {
            ...
            var result = new
            {
                ...
                investigacionfomentoconvocatoria.IdFacultad,
                investigacionfomentoconvocatoria.nroplaza,
                investigacionfomentoconvocatoria.presupuesto,
                fechainiinscripcion = investigacionfomentoconvocatoria.fechainiinscripcion.ToLocalDateTimeFormat(),
                fechafininscripcion = investigacionfomentoconvocatoria.fechafininscripcion.ToLocalDateTimeFormat(),
                investigacionfomentoconvocatoria.dirigidoa,
                imagenarchivo = investigacionfomentoconvocatoria.imagenarchivo??"",
