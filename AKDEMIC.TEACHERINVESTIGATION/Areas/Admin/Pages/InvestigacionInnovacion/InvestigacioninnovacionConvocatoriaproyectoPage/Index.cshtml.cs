...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.Admin.Pages.InvestigacionInnovacion.InvestigacioninnovacionConvocatoriaproyectoPage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetDatatableAsync(string searchValue = null, string tipousuario = "")
        {
            ...
            {
                searchValue = xIdOficina.ToString();
            }
            ...
            if (tipousuario == "R")
            {
                ...
                var queryproyectodetalle2 =  _context.InvestigacionfomentoConvocatoriaproyectosflujos
                   ...
                   .AsNoTracking();
                Console.WriteLine("3sss3");
                var lst = queryproyectodetalle2.ToList();
                var n = lst.Count();
                for(int i = 0; i < n; i++)
                {
                    Console.WriteLine(lst[0].IdConvocatoriaproyecto);
                    Console.WriteLine(lst[0].retornadocente);
                ...
                .Select(x => new
                {
                    ...
                    x.queryproyectodetalle2_1.estado2,
                    x.queryproyectodetalle2_1.orden1,
                    x.queryproyectodetalle2_1.orden2,
                })
                .Where(x => (tipousuario == "R" ? x.estado == "1" : "1" == "1"  ) && x.retornadocente == "0")
                .Skip(sentParameters.PagingFirstRecord)
                .Take(sentParameters.RecordsPerDraw)
                .ToListAsync();
                Console.WriteLine(xIdOficina);
