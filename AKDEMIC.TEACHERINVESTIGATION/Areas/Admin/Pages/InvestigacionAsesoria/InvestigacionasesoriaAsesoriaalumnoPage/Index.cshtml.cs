...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.Admin.Pages.InvestigacionAsesoria.InvestigacionasesoriaAsesoriaalumnoPage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetDatatableAsync(string searchValue = null, string searchIdtipo = null)
        {
            ...
            var queryalumno = _context.MaestroAlumnos.Where(x=>x.IdUser == Guid.Parse(user.Id) ||  Guid.Parse(user.Id) == Guid.Parse("3f8d18e6-d79d-4d1b-938a-0741c3dbcfa4")).AsNoTracking();
