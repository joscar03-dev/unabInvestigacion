...
namespace AKDEMIC.TEACHERINVESTIGATION.Areas.IncubatorUnit.Pages.IncubatorConvocationPage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            var incubatorConvocation = await _context.IncubatorConvocations.Where(x => x.Id == id).FirstOrDefaultAsync();
            if (incubatorConvocation == null)
                return BadRequest("Sucedio un Error");

            _context.IncubatorConvocations.Remove(incubatorConvocation);
