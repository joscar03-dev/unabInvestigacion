var index = function () {
    ...
    var datatable = {
        postulant : {
            ...
            options: {
                ajax: {
                    url: `/evaluador/postulantes-investigacion`,
                    data: function (data) {
                        delete data.columns;
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (row) {
                            var tpm = "";
                            tpm += `<a href="/evaluador/postulantes-investigacion/${row.id}/detalles" class="btn btn-primary m-btn btn-sm m-btn m-btn--icon"><span><i class="la la-eye"></i><span>Detalles</span></span></a> `;

                            if (row.reviewState == 3) {
                                tpm += `<a href="/evaluador/postulantes-investigacion/${row.id}/calificar" class="btn btn-primary m-btn btn-sm m-btn m-btn--icon"><span><i class="la la-edit"></i><span>Calificar</span></span></a>`;
                            }
