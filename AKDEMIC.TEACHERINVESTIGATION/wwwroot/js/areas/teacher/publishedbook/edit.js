var InitApp = function () {
    var publishedBookId = $("#Input_Id").val();
    ...
    var datatable = {
        author: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/investigador/libros-publicados/${publishedBookId}/editar`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                ...
                swal({
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: (`/investigador/libros-publicados/${publishedBookId}/editar?handler=DeleteAuthor`).proto().parseURL(),
                                type: "POST",
                                data: {
                                    id: id
                                },
            ...
            edit: {
                ...
                load: function (id) {
                    $.ajax({
                        ...
                        $("#file-editform input[name=PublishedBookId]").val(result.publishedBookId);
            ...
            delete: function (id) {
                swal({
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: (`/investigador/libros-publicados/${publishedBookId}/editar?handler=DeleteFile`).proto().parseURL(),
                                type: "POST",
                                data: {
                                    id: id
                                },
            ...
            $("#edit-form").validate({
                submitHandler: function (form, e) {
                    ...
                    $.ajax({
                        ...
                        toastr.success(_app.constants.toastr.message.success.task, _app.constants.toastr.title.success);
                        location.href = `/investigador/libros-publicados`.proto().parseURL();
                    }).fail(function (error) {
                        toastr.error(error.responseText, _app.constants.toastr.title.error);
