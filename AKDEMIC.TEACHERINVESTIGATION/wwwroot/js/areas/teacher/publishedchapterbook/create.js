                ...
                $("#create-form").validate({
                    submitHandler: function (formElement, e) {
                        ...
                        for (var i = 0; i < authorArr.length; i++) {
                            formData.append(`Input.PublishedChapterBookAuthors[${i}].PaternalSurname`, authorArr[i].paternalSurname);
                            formData.append(`Input.PublishedChapterBookAuthors[${i}].MaternalSurname`, authorArr[i].maternalSurname);
                            formData.append(`Input.PublishedChapterBookAuthors[${i}].Name`, authorArr[i].name);
                            formData.append(`Input.PublishedChapterBookAuthors[${i}].Email`, authorArr[i].email);
                            formData.append(`Input.PublishedChapterBookAuthors[${i}].Dni`, authorArr[i].dni);
                        }

                        for (var i = 0; i < fileArr.length; i++) {
                            formData.append(`Input.PublishedChapterBookFiles[${i}].File`, fileArr[i].file);
                            formData.append(`Input.PublishedChapterBookFiles[${i}].Name`, fileArr[i].name);
                        }
                        $.ajax({
                            ...
                            location.href = `/investigador/capitulos-libros-publicados/crear`.proto().parseURL();
                        }).fail(function (error) {
