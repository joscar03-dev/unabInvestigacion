                ...
                $("#create-form").validate({
                    submitHandler: function (formElement, e) {
                        ...
                        for (var i = 0; i < authorArr.length; i++) {
                            formData.append(`Input.Authors[${i}].PaternalSurname`, authorArr[i].paternalSurname);
                            formData.append(`Input.Authors[${i}].MaternalSurname`, authorArr[i].maternalSurname);
                            formData.append(`Input.Authors[${i}].Name`, authorArr[i].name);
                            formData.append(`Input.Authors[${i}].Email`, authorArr[i].email);
                            formData.append(`Input.Authors[${i}].Dni`, authorArr[i].dni);
                        }
                        for (var i = 0; i < fileArr.length; i++) {
                            formData.append(`Input.PublicationFiles[${i}].File`, fileArr[i].file);
                            formData.append(`Input.PublicationFiles[${i}].Name`, fileArr[i].name);
                        }
                        $.ajax({
                            ...
                            location.href = `/investigador/publicaciones/crear`.proto().parseURL();
                        }).fail(function (error) {
