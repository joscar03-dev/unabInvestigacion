                ...
                $("#create-form").validate({
                    submitHandler: function (formElement, e) {
                        ...
                        for (var i = 0; i < authorArr.length; i++) {
                            formData.append(`Input.ConferenceAuthors[${i}].PaternalSurname`, authorArr[i].paternalSurname);
                            formData.append(`Input.ConferenceAuthors[${i}].MaternalSurname`, authorArr[i].maternalSurname);
                            formData.append(`Input.ConferenceAuthors[${i}].Name`, authorArr[i].name);
                            formData.append(`Input.ConferenceAuthors[${i}].Email`, authorArr[i].email);
                            formData.append(`Input.ConferenceAuthors[${i}].Dni`, authorArr[i].dni);
                        }
                        for (var i = 0; i < fileArr.length; i++) {
                            formData.append(`Input.ConferenceFiles[${i}].File`, fileArr[i].file);
                            formData.append(`Input.ConferenceFiles[${i}].Name`, fileArr[i].name);
                        }
                        $.ajax({
                            ...
                            location.href = `/investigador/congresos/crear`.proto().parseURL();
                        }).fail(function (error) {
    ...
    var datePickers = {
        init: function () {
            $("#Input_StartDate").datepicker({
                ...
                $("#Input_EndDate").datepicker("setStartDate", e.date);
            });
            ...
            $("#Input_EndDate").datepicker({
                ...
                $("#Input_StartDate").datepicker("setEndDate", e.date);
            });
