var InitApp = function () {
    ...
    var datatable = {
        author: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/investigador/congresos/${conferenceId}/editar`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                ...
                swal({
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: (`/investigador/congresos/${conferenceId}/editar?handler=DeleteAuthor`).proto().parseURL(),
                                type: "POST",
                                data: {
                                    id: id
                                },
            ...
            edit: {
                ...
                load: function (id) {
                    $.ajax({
                        ...
                        $("#file-editform input[name=ConferenceId]").val(result.conferenceId);
            ...
            delete: function (id) {
                swal({
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: (`/investigador/congresos/${conferenceId}/editar?handler=DeleteFile`).proto().parseURL(),
                                type: "POST",
                                data: {
                                    id: id
                                },
            ...
            $("#edit-form").validate({
                submitHandler: function (formElement, e) {
                    ...
                    $.ajax({
                        ...
                        toastr.success(_app.constants.toastr.message.success.task, _app.constants.toastr.title.success);
                        location.href = `/investigador/congresos`.proto().parseURL();
                    }).fail(function (error) {
                        toastr.error(error.responseText, _app.constants.toastr.title.error);
    ...
    var datePickers = {
        init: function () {
            ...
            $("#Input_StartDate").datepicker('update', startDate);
            $("#Input_EndDate").datepicker('update', endDate);

            $("#Input_StartDate").datepicker("setEndDate", endDate);
            $("#Input_EndDate").datepicker("setStartDate", startDate);
        }
    }
