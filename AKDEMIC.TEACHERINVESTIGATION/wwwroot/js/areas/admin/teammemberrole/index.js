    ...
    var datatable = {
        teamMemberRole: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/roles-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.teamMemberRole.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.teamMemberRole.reload();
            });
        }
    };
    var modal = {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/roles-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                ...
                                }).then(datatable.teamMemberRole.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El rol presenta información relacionada"
                                });
                            }
                        });
                    });
