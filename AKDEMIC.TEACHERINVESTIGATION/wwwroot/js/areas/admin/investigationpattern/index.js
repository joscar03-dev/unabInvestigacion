    ...
    var datatable = {
        investigationPattern: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/investigacion-tipo-forma".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigationPattern.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La forma de investigación será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/investigacion-tipo-forma?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La forma de investigación ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigationPattern.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La forma de investigación presenta información relacionada"
                                });
                            }
                        });
                    });
