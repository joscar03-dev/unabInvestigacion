    ...
    var datatable = {
        externalEntity: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/entidades-externas".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.externalEntity.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La entidad externa será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/entidades-externas?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La entidad externa ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.externalEntity.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La entidad externa presenta información relacionada"
                                });
                            }
                        });
                    });
