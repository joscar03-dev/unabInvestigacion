    ...
    var datatable = {
        methodologyType: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/tipo-de-metodologia".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.methodologyType.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El tipo de metodología será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/tipo-de-metodologia?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El tipo de metodología ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.methodologyType.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El tipo de metodología presenta información relacionada"
                                });
                            }
                        });
                    });
