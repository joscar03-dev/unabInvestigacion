    ...
    var datatable = {
        investigationType: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/tipo-de-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigationType.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El tipo de investigación será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/tipo-de-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El tipo de investigación ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigationType.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El tipo de investigación presenta información relacionada"
                                });
                            }
                        });
                    });
