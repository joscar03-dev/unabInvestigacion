    ...
    var datatable = {
        investigationProjectType: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/tipo-proyecto".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.investigationProjectType.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigationProjectType.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El tipo de proyecto será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/tipo-proyecto?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El tipo de proyecto ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigationProjectType.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El tipo de proyecto presenta información relacionada"
                                });
                            }
                        });
                    });
