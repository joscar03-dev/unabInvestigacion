var InitApp = function () {
    var InvestigationProjectId = $("#InvestigationProjectId").val();
    var datatable = {
        investigationProject: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/admin/proyectos/${InvestigationProjectId}/entregables`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var datePickers = {
        ...
        investigationConvocationDate: {
            init: function () {
                $("#add-form input[name=ExpirationDate]").datepicker({
                    clearBtn: true,
                    orientation: "bottom",
                    format: _app.constants.formats.datepicker
                })
                $("#edit-form input[name=ExpirationDate]").datepicker({
                    clearBtn: true,
                    orientation: "bottom",
                    format: _app.constants.formats.datepicker
                })
    ...
    var modal = {
        ...
        edit: {
            ...
            load: function (id) {
                $.ajax({
                    ...
                    $("#edit-form input[name=ExpirationDate]").datepicker('update', result.expirationDate);
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El Entregable será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: (`/admin/proyectos/${InvestigationProjectId}/entregables?handler=Delete`).proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Entregable ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigationProject.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Entregable presenta información relacionada"
                                });
                            }
                        });
                    });
