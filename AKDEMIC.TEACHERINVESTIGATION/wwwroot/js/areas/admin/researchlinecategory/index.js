    ...
    var datatable = {
        researchLineCategory: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/categoria-linea-de-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            ...
                            //ResearchLine
                            template += `<a class='btn btn-accent m-btn btn-sm  m-btn--icon-only' href='/admin/linea-de-investigacion/${data.id}' `;
                            template += `<span><i class="la la-wrench"></i><span>Línea de Investigación</span></span></a> `;
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.researchLineCategory.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La categoría de investigación será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/categoria-linea-de-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La categoría de investigación ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.researchLineCategory.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La categoría de investigación presenta información relacionada"
                                });
                            }
                        });
                    });
