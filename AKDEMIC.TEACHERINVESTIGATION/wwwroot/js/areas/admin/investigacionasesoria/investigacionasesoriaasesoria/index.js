var InitApp = function () {
    ...
    var datatable = {
        investigacionasesoriaAsesoria: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/Investigacionasesoria/asesoria".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
    ...
    var modal = {        
        create: {
            ...
            clear: function () {
                $("#edit-form select[name=IdAnio]").val('');
                $("#add-form select[name=IdAnio]").trigger("change");
                $("#edit-form select[name=IdCarrera]").val('');
                $("#add-form select[name=IdCarrera]").trigger("change");
                $("#edit-form select[name=IdAsesor]").val('');
                $("#add-form select[name=IdAsesor]").trigger("change");
                $("#edit-form select[name=IdAlumno]").val('');
                $("#add-form select[name=IdAlumno]").trigger("change");
                $("#edit-form select[name=IdAlumno2]").val('');
                $("#add-form select[name=IdAlumno2]").trigger("change");
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/Investigacionasesoria/asesoria?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        enviar: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/Investigacionasesoria/asesoria?handler=EnviarPlan").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
