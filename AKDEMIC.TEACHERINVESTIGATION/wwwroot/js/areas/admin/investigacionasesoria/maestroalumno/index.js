    ...
    var datatable = {
        maestroAlumno: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/alumno".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroAlumno.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroAlumno.reload();
            });
        }
    };
    var modal = {
        create: {
            ...
            clear: function () {
                $("#add-form select[name=IdCarrera]").val("");
                $("#add-form select[name=IdCarrera]").trigger("change");
                $("#add-form select[name=IdUser]").val("");
                $("#add-form select[name=IdUser]").trigger("change");
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/alumno?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Alumno ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.maestroAlumno.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Alumno presenta información relacionada"
                                });
                            }
                        });
                    });
