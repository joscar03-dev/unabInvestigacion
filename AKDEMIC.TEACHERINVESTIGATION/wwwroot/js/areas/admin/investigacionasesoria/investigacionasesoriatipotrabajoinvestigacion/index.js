var InitApp = function () {
    ...
    var datatable = {
        investigacionasesoriaTipotrabajoinvestigacion: {
            object: null,
            options: {
                serverSide: true,
                filter: false,
                lengthChange: false,
                ajax: {
                    url: "/investigacionasesoria/tipotrabajoinvestigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.investigacionasesoriaTipotrabajoinvestigacion.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigacionasesoriaTipotrabajoinvestigacion.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El tipo de Trabajo será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionasesoria/tipotrabajoinvestigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El tipo de trabajo ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigacionasesoriaTipotrabajoinvestigacion.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El tipo de trabajo presenta información relacionada"
                                });
                            }
                        });
                    });
