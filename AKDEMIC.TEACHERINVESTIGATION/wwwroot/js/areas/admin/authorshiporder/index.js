    ...
    var datatable = {
        authorshipOrder: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/orden-autoria".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.authorshipOrder.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El orden de autoria será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/orden-autoria?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El orden de autoria ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.authorshipOrder.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El orden de autoria presenta información relacionada"
                                });
                            }
                        });
                    });
