    ...
    var datatable = {
        evaluatorCommittee: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/admin/convocatoria-de-investigacion/${investigationConvocationId}/comite-evaluador`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.evaluatorCommittee.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.evaluatorCommittee.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El miembro del comité evaluador será eliminado.",
                type: "warning",
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El miembro del comité evaluador ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.evaluatorCommittee.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El miembro del comité evaluador presenta información relacionada"
                                });
                            }
                        });
                    });
