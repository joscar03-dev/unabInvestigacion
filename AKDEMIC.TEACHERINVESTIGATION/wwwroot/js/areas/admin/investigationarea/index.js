    ...
    var datatable = {
        investigationArea: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/areas-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.investigationArea.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigationArea.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El área de investigación será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/areas-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El área de investigación ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigationArea.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El área de investigación presenta información relacionada"
                                });
                            }
                        });
                    });
