    ...
    var datatable = {
        maestroAreaacademica: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/laboratorio".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/laboratorio?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Laboratorio ha sido eliminado con exito",
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Laboratorio presenta información relacionada"
                                });
                            }
                        });
                    });
