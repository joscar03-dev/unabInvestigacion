    ...
    var datatable = {
        maestroAreaacademica: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/equipo".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/equipo?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Equipo ha sido eliminado con exito",
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Equipo presenta información relacionada"
                                });
                            }
                        });
                    });
