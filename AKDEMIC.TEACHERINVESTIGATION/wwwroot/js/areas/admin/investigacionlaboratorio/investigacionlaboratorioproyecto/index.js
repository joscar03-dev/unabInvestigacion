    ...
    var datatable = {
        maestroAreaacademica: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/investigacionlaboratorio/proyecto".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionlaboratorio/proyecto?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Proyecto presenta información relacionada"
                                });
                            }
                        });
                    });
