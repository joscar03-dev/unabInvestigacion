    ...
    var datatable = {
        investigacionformativaComite: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/InvestigacionIncubadoranew/evaluadorexterno".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.investigacionformativaComite.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigacionformativaComite.reload();
            });
        }
    };
    var modal = {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/evaluadorexterno?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Miembro de comite ha sido eliminado con exito",
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Miembro de comite presenta información relacionada"
                                });
                            }
                        });
                    });
