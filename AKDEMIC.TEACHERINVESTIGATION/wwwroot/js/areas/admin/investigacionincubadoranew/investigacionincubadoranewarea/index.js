    ...
    var datatable = {
        maestroArea: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/InvestigacionIncubadoranew/area".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            var template = "";
                            //persona
                            template += "<button title='Registrar Usuarios'  style='background-color:#aaeee8' ";
                            template += " class='btn  btn-actividades ";
                            template += " m-btn btn-sm  m-btn--icon-only' ";
                            template += " data-id='" + data.id + "' > ";
                            template += "<span><i class='la la-user'></i><span>Usuarios</span></span></button>";
                            //Edit
                            template += "<button ";
        ...
        init: function () {
            this.maestroArea.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroArea.reload();
            });
        }
    };
    var modal = {
        addactividades: {
            ...
            options: {
                ...
                ajax: {
                    ...
                    dataType: "JSON",
                    data: function (data) {
                        data.handler = "DatatableUsuarios";
            ...
            load: function (id) {
                ...
                $("#nuevoactividades-form input[name=IdArea]").val(id);
                if (this.object == null) {
        ...
        createusuario: {
            object: $("#nuevoactividades-form").validate({
                submitHandler: function (form, e) {
                    ...
                    $.ajax({
                        ...
                        $("#nuevoactividades-form select[name=IdUser]").val("");
                        $("#nuevoactividades-form select[name=IdUser]").trigger("change");
            ...
            clear: function () {
                modal.createusuario.object.resetForm();
            },
            events: function () {
        ...
        editusuario: {
            ...
            load: function (id) {
                ...
                $.ajax({
                    ...
                    $("#editactividades-form input[name=IdArea]").val(result.idArea);
                    $("#editactividades-form select[name=IdUser]").val(result.idUser);
                    $("#editactividades-form select[name=IdUser]").trigger("change");
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/area?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                ...
                                }).then(datatable.maestroArea.reload());
                            },
        ...
        deleteusuario: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/area?handler=Deleteusuario").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        init: function () {
            this.create.events();
            this.createusuario.events();
            this.edit.events();
            this.addactividades.events();
            this.editusuario.events();
