var InitApp = function () {
    ...
    var datatable = {
        maestroCategoriaconvocatoria: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/InvestigacionIncubadoranew/categoriaconvocatoria".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La categoriaconvocatoria será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/categoriaconvocatoria?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
