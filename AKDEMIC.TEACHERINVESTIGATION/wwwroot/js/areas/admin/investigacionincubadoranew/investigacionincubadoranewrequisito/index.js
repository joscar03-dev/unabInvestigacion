    ...
    var datatable = {
        maestroCategoriaconvocatoria: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/InvestigacionIncubadoranew/requisito".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/requisito?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El requisito ha sido eliminado con exito",
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El requisito presenta información relacionada"
                                });
                            }
                        });
                    });
