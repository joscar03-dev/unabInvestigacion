    ...
    var datatable = {
        maestroTipoconvocatoria: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/InvestigacionIncubadoranew/tipoconvocatoria".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroTipoconvocatoria.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroTipoconvocatoria.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La tipoconvocatoria será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/InvestigacionIncubadoranew/tipoconvocatoria?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                ...
                                }).then(datatable.maestroTipoconvocatoria.reload());
                            },
