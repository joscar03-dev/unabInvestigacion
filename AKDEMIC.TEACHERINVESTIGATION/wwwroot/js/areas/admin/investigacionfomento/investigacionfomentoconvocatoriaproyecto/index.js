        ...
        researcherInvestigacionfomentoConvocatoria: {
            ...
            load: function () {
                $.ajax({
                    ...
                    type: "GET",
                    data: "idoficina=e0557aa7-6404-11ee-b7b1-16d13ee00159",
                }).done(function (result) {
    ...
    var datatable = {
        investigacionfomentoConvocatoriaproyecto: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/investigacionfomento/convocatoriaproyecto".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
...
//                        modal.newactividadcronograma.clear();
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionfomento/convocatoriaproyecto?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        enviar: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/convocatoriaproyecto?handler=EnviarProyecto").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        enviaranexo: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/convocatoriaproyecto?handler=EnviarAnexoproyecto").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        pdfcartapresentacion: function (id) {
                        ...
                        $.ajax({
                            url: ("/investigacionfomento/convocatoriaproyecto?handler=Pdfcartapresentacion").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
