    ...
    var datatable = {
        investigacionfomentoIndicador: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/investigacionfomento/listaverificacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionfomento/listaverificacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        deleteindicador: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/listaverificacion?handler=Deleteindicador").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
