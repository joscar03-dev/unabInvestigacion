    ...
    var datatable = {
        maestroFlujo: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/investigacionfomento/flujo".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionfomento/flujo?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        deletearea: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/flujo?handler=Deletearea").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
