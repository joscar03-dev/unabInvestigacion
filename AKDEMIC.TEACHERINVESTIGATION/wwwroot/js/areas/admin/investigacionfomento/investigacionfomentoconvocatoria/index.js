    ...
    var datatable = {
        investigacionfomentoConvocatoria: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/investigacionfomento/convocatoria".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionfomento/convocatoria?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        deletearearequisito: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/convocatoria?handler=Deletearearequisito").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        deletearealistaverificacion: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/convocatoria?handler=Deletearealistaverificacion").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        enviar: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/investigacionfomento/convocatoria?handler=EnviarPlan").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
