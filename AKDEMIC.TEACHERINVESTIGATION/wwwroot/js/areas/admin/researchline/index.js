var InitApp = function () {
    var ResearchLineId = $("#ResearchLineId").val();
    var datatable = {
        researchLine: {
            object: null,
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/admin/linea-de-investigacion/${ResearchLineId}`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La linea de Investigación será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: (`/admin/linea-de-investigacion/${ResearchLineId}?handler=Delete`).proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La linea de Investigación ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.researchLine.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La linea de Investigación presenta información relacionada"
                                });
                            }
                        });
                    });
