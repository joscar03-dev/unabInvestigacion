    ...
    var datatable = {
        identificationType: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/tipo-de-identificacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.identificationType.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El tipo de identificación será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/tipo-de-identificacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El tipo de identificación ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.identificationType.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El tipo de identificación presenta información relacionada"
                                });
                            }
                        });
                    });
