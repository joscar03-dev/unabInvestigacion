    ...
    var datatable = {
        maestroArea: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestroinnovacion/area".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestroinnovacion/area?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
        ...
        deleteusuario: function (id) {
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/maestroinnovacion/area?handler=Deleteusuario").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
