var InitApp = function () {
    var datatable = {
        indexPlace: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/indexada".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La indexada será eliminada.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/indexada?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La indexada ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.indexPlace.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La indexada presenta información relacionada"
                                });
                            }
                        });
                    });
