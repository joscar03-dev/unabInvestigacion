    ...
    var datatable = {
        postulations: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/postulaciones".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                        delete data.columns;
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            switch (data.projectState) {
                                case 0:
                                    return `<span class="m--font-warning">${data.projectStateText}</span>`;
                                case 1:
                                    return `<span class="m--font-info">${data.projectStateText}</span>`;
                                case 2:
                                    return `<span class="m--font-danger">${data.projectStateText}</span>`;
                                case 3:
                                    return `<span class="m--font-success">${data.projectStateText}</span>`;
                                default:
                                    return `<span class="m--font-primary">${data.projectStateText}</span>`;
                            }
                        }
                    },
                    
                    {
                        ...
                        orderable: false,
                        render: function (data) {
                            var detailUrl = `/admin/postulaciones/detalle/${data.id}`; 
                            var template = "";
