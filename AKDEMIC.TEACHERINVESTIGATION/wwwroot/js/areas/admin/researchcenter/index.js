    ...
    var datatable = {
        researchCenter: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/centro-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.researchCenter.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El centro investigación será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/centro-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El centro investigación ha sido eliminada con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.researchCenter.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El centro investigación presenta información relacionada"
                                });
                            }
                        });
                    });
