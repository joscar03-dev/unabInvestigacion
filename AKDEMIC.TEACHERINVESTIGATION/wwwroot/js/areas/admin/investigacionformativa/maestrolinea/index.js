    ...
    var datatable = {
        maestroLinea: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/linea".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroLinea.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroLinea.reload();
            });
        }
    };
    var modal = {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/linea?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La Linea ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.maestroLinea.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La Linea presenta información relacionada"
                                });
                            }
                        });
                    });
