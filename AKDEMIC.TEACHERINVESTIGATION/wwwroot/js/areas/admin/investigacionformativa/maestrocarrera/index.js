    ...
    var datatable = {
        maestroCarrera: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/carrera".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroCarrera.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroCarrera.reload();
            });
        }
    };
    var modal = {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/carrera?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                ...
                                }).then(datatable.maestroCarrera.reload());
                            },
