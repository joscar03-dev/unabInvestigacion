    ...
    var datatable = {
        maestroFacultad: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/facultad".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroFacultad.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroFacultad.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "La facultad será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/facultad?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "La Facultad ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.maestroFacultad.reload());
                            },
