var InitApp = function () {
    ...
    var datatable = {
        investigacionformativaConfiguraranio: {
            object: null,
            options: {
                serverSide: true,
                filter: false,
                lengthChange: false,
                ajax: {
                    url: "/investigacionformativa/configuraranio".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.investigacionformativaConfiguraranio.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.investigacionformativaConfiguraranio.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El Area académica será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/investigacionformativa/configuraranio?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Area académica ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.investigacionformativaConfiguraranio.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "La Facultad presenta información relacionada"
                                });
                            }
                        });
                    });
