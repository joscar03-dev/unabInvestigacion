    ...
    var datatable = {
        maestroDepartamento: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/maestro/departamento".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
        ...
        init: function () {
            this.maestroDepartamento.init();
        }
    };
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.maestroDepartamento.reload();
            });
        }
    };
    var modal = {
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {                        
                        $.ajax({
                            url: ("/maestro/departamento?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                ...
                                }).then(datatable.maestroDepartamento.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Departamento presenta información relacionada"
                                });
                            }
                        });
                    });
