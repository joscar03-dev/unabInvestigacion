    ...
    var datatable = {
        financingInvestigation: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: "/admin/financiamiento-investigacion".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
    ...
    var search = {
        init: function () {
            $("#search").doneTyping(function () {
                datatable.financingInvestigation.reload();
            });
        }
    };
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El financiamiento de investigación será eliminado.",
                type: "warning",
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        $.ajax({
                            url: ("/admin/financiamiento-investigacion?handler=Delete").proto().parseURL(),
                            type: "POST",
                            data: {
                                id: id
                            },
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El financiamiento de investigación ha sido eliminado con exito",
                                    confirmButtonText: "Excelente"
                                }).then(datatable.financingInvestigation.reload());
                            },
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El financiamiento de investigación presenta información relacionada"
                                });
                            }
                        });
                    });
