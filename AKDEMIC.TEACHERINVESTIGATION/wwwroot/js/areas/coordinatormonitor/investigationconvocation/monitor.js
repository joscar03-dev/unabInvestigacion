var InitApp = function () {
    ...
    var datatable = {
        monitor: {
            ...
            options: {
                ...
                lengthChange: false,
                ajax: {
                    url: `/coordinador-monitor/convocatoria-investigacion/${investigationConvocationId}/monitores`.proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                        data.handler = "MonitorDatatable";
    ...
    var modal = {
        ...
        delete: function (id) {
            swal({
                title: "¿Está seguro?",
                text: "El Monitor será eliminado de la convocatoria.",
                type: "warning",
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                swal({
                                    type: "success",
                                    title: "Completado",
                                    text: "El Monitor ha sido eliminado con exito",
                            ...
                            error: function (errormessage) {
                                swal({
                                    ...
                                    text: "El Monitor presenta información relacionada"
                                });
                            }
                        });
                    });
